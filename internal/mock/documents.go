...
func GetMockDocuments() []models.Document {
	return []models.Document{
		...
		*models.NewDocument("Top Secret Case Study", "All contents of this document should be kept a secret. Only admins should have this document. Do NOT shore with anyone!", true),
	}
}
